...
Diactrics.clean = function(input) {
	...
	var char;
	haxe_Log.trace(chars,{ fileName : "src/Diactrics.hx", lineNumber : 13, className : "Diactrics", methodName : "clean"});
	var _g = 0;
...
Mots.underclean = function(str,separator) {
	...
	var nonWordChar = new EReg("[\\xC0-\\xFF\\s\\W]","g");
	str = str.replace(nonWordChar.r,separator);
	haxe_Log.trace("sfrtrr" + Std.string(nonWordChar),{ fileName : "src/Mots.hx", lineNumber : 6, className : "Mots", methodName : "underclean"});
	return str;
};
Mots.undercleanFile = function(str) {
...
Mots.stripEmoj = function(str) {
	var _this_r = new RegExp(Mots.emojRange,"g".split("u").join(""));
	return str.replace(_this_r,"");
};
...
RunAll.main = function() {
	haxe_Log.trace("runAll",{ fileName : "tests/RunAll.hx", lineNumber : 8, className : "RunAll", methodName : "main"});
	var runner = new utest_Runner();
	runner.addCase(new TestMots());
	utest_ui_Report.create(runner);
	runner.run();
	haxe_Log.trace(Mots.stripEmoj("🎃zeze"),{ fileName : "tests/RunAll.hx", lineNumber : 16, className : "RunAll", methodName : "main"});
	haxe_Log.trace("op",{ fileName : "tests/RunAll.hx", lineNumber : 17, className : "RunAll", methodName : "main"});
};
var Std = function() { };
Std.__name__ = "Std";
...
TestMots.prototype = {
	testtest: function() {
		haxe_Log.trace("yo",{ fileName : "tests/TestMots.hx", lineNumber : 13, className : "TestMots", methodName : "testtest"});
		utest_Assert.isTrue(true,null,{ fileName : "tests/TestMots.hx", lineNumber : 14, className : "TestMots", methodName : "testtest"});
	}
	,testUnderClean: function() {
		utest_Assert.equals("Ca_pture_d__cra__n_2019_02__04___17_27_05_pngCap_tu_r__e_d__cr_an_2019_02_04___17_27_05_png",Mots.underclean(TestMots.fileName),null,{ fileName : "tests/TestMots.hx", lineNumber : 19, className : "TestMots", methodName : "testUnderClean"});
	}
	,testundercleanFile: function() {
		var str = Mots.undercleanFile(TestMots.fileName);
		haxe_Log.trace("strrrr" + str,{ fileName : "tests/TestMots.hx", lineNumber : 24, className : "TestMots", methodName : "testundercleanFile"});
		utest_Assert.equals("CaaptureDEcran201902u04A172705PngCapatuaereeeDEcraan20190204A172705.png",str,null,{ fileName : "tests/TestMots.hx", lineNumber : 25, className : "TestMots", methodName : "testundercleanFile"});
		utest_Assert.equals("png",Mots.getExtension(str),null,{ fileName : "tests/TestMots.hx", lineNumber : 26, className : "TestMots", methodName : "testundercleanFile"});
	}
	,testCleanAccents: function() {
		utest_Assert.equals("Caapture d’ecra🐠n 2019-02u-04 a 17.27.05.pngCapatuaereee d’ecraan 2019-02-04 a 17.27.05.png",Mots.cleanAccents(TestMots.fileName),null,{ fileName : "tests/TestMots.hx", lineNumber : 30, className : "TestMots", methodName : "testCleanAccents"});
	}
	,testCapitalize: function() {
		utest_Assert.equals("David",Mots.capitalize("david"),null,{ fileName : "tests/TestMots.hx", lineNumber : 37, className : "TestMots", methodName : "testCapitalize"});
	}
	,testCleanPath: function() {
		utest_Assert.equals("../david/Zelote/magali/lupin.jpg",Mots.cleanPath("..//david/Zelote//magali/lupin.jpg//"),null,{ fileName : "tests/TestMots.hx", lineNumber : 43, className : "TestMots", methodName : "testCleanPath"});
	}
	,testEndWith: function() {
		utest_Assert.isTrue(Mots.endsWith("pur","r"),null,{ fileName : "tests/TestMots.hx", lineNumber : 48, className : "TestMots", methodName : "testEndWith"});
	}
	,testCamel: function() {
		var str = "je suis une vache";
		str = Mots.camelize("je suis une vache");
		utest_Assert.equals("jeSuisUneVache",str,null,{ fileName : "tests/TestMots.hx", lineNumber : 60, className : "TestMots", methodName : "testCamel"});
	}
	,testContain: function() {
		utest_Assert.isTrue("bonjour".indexOf("j") >= 0,null,{ fileName : "tests/TestMots.hx", lineNumber : 65, className : "TestMots", methodName : "testContain"});
	}
	,testExtension: function() {
		["one.png","two.tar.gz",".htaccess","four.jpeg"].map(function(n) {
			utest_Assert.equals(haxe_io_Path.extension(n),Mots.getExtension(n),null,{ fileName : "tests/TestMots.hx", lineNumber : 72, className : "TestMots", methodName : "testExtension"});
			return null;
		});
	}
	,testunCamel: function() {
		...
		utest_Assert.equals("je suis une vache",str,null,{ fileName : "tests/TestMots.hx", lineNumber : 82, className : "TestMots", methodName : "testunCamel"});
	}
	,testMatchEmoj: function() {
		utest_Assert.isTrue(Mots.matchEmoj("👽😬hallowe🐬en"),null,{ fileName : "tests/TestMots.hx", lineNumber : 90, className : "TestMots", methodName : "testMatchEmoj"});
	}
	,testStripEmoj: function() {
		utest_Assert.equals("halloween",Mots.stripEmoj("👽😬hallowe🐬en"),null,{ fileName : "tests/TestMots.hx", lineNumber : 96, className : "TestMots", methodName : "testStripEmoj"});
	}
	,__initializeUtest__: function() {
		...
		init.tests.push({ name : "testundercleanFile", execute : function() {
