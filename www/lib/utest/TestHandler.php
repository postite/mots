...
class TestHandler {
	...
	static public function exceptionStack ($pops = 2) {
		...
		while (true) {
			#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/TestHandler.hx:86: characters 12-18
			$pops = $pops - 1;
			#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/TestHandler.hx:86: lines 86-87
			if (!(($pops + 1) > 0)) {
				#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/TestHandler.hx:86: lines 86-87
	...
	public function bindHandler () {
		...
		Assert::$createAsync = new HxClosure($this, 'addAsync');
		...
		Assert::$createEvent = new HxClosure($this, 'addEvent');
	...
	public function checkTested () {
		...
		if (($this->expiration === null) || ($this->asyncStack->length === 0)) {
			...
			Timer::delay(new HxClosure($this, 'checkTested'), 10);
		}
	}
