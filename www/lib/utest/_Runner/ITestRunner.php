...
class ITestRunner {
	...
	public function run () {
		...
		$this->cases = new NativeArrayIterator($this->runner->iTestFixtures->_keys);
	...
	public function runFixtures ($finishedHandler = null) {
		...
		while ($this->currentCaseFixtures->length > 0) {
			...
			if (!$handler->finished) {
				...
				$handler->onComplete->add(new HxClosure($this, 'runFixtures'));
	...
	public function setupFailed ($assertation) {
		#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Runner.hx:357: characters 5-11
		$tmp = $this->runner;
		...
		$tmp->executedFixtures = $tmp->executedFixtures + $this->currentCaseFixtures->length;
		...
		$tmp3 = TestResult::ofFailedSetupClass($this->currentCase, $assertation);
