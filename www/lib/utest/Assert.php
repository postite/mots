				...
				if (Assert::isIterator($expected, true)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						while ($_g11 < $_g2) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:446: lines 446-453
							$_g11 = $_g11 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:446: characters 17-18
							$i = $_g11 - 1;
				...
				if (Assert::isIterable($expected, true)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						while ($_g12 < $_g3) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:472: lines 472-476
							$_g12 = $_g12 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:472: characters 17-18
							$i1 = $_g12 - 1;
			...
			case 6:
				...
				if (($expected instanceof \Array_hx)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						$_g13 = 0;
						#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:258: lines 258-265
						$_g4 = Boot::dynamicField($expected, 'length');
						#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:258: lines 258-265
						while ($_g13 < $_g4) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:258: lines 258-265
							$_g13 = $_g13 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:258: characters 17-18
							$i2 = $_g13 - 1;
				...
				if (($expected instanceof Bytes)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						while ($_g14 < $_g5) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:285: lines 285-290
							$_g14 = $_g14 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:285: characters 18-19
							$i3 = $_g14 - 1;
				...
				if (Assert::isIterator($expected, false)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						while ($_g16 < $_g7) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:330: lines 330-337
							$_g16 = $_g16 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:330: characters 17-18
							$i4 = $_g16 - 1;
				...
				if (Assert::isIterable($expected, false)) {
					...
					if ($status->recursive || ($status->path === "")) {
						...
						while ($_g17 < $_g8) {
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:352: lines 352-356
							$_g17 = $_g17 + 1;
							#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:352: characters 17-18
							$i5 = $_g17 - 1;
			...
			case 7:
				...
				if ($status->recursive || ($status->path === "")) {
					...
					while ($_g18 < $_g10) {
						#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:394: lines 394-402
						$_g18 = $_g18 + 1;
						#/Users/ut/haxe/haxe_libraries/utest/1.9.5/github/aca590b256e0879cd7fbfcd47ca4f3a0a0ce1845/src/utest/Assert.hx:394: characters 16-17
						$i6 = $_g18 - 1;
				...
				if ($msg === null) {
					...
					if ($p > 0) {
						...
						if (strlen($cut) > 30) {
							...
							$cut = "..." . (HxString::substr($cut, -27)??'null');
						}
